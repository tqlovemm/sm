<?php echo ÁÔÂíÍø, http://www.iliema.com/ ';exit;?>
	...
	<div class="wp">
    	<div class="wk_forum">
            ...
            <div class="wk_foeum620">
                <div id="wk_ftj">
                    <dl>
                        <dd class="selected">$week_lang[12]</dd>
                        <dd>$week_lang[13]</dd>
                        <dd>$week_lang[14]</dd>
                        <dd>$week_lang[15]</dd>
                        <dd>$week_lang[16]</dd>
                    ...
                    <div class="wk_fsx">
                        <div class="wk_f620"><!--[diy=wk_f620e]--><div id="wk_f620e" class="area"></div><!--[/diy]--></div>
                    </div>
                </div>
            </div>
 		</div>
...
<script type="text/javascript" src="$_G['style'][styleimgdir]/js/week_min.js"></script>
<script type="text/javascript">
SJX(function() {
	var SJXitems = SJX('#wk_ftj dl dd');
	SJXitems.mouseover(function() {
		SJXitems.removeClass('selected');
		SJX(this).addClass('selected');
		var index = SJXitems.index(SJX(this));
		SJX('#wk_ftj .wk_fsx').hide().eq(index).show();
	}).eq(0).mouseover();
});
</script>
