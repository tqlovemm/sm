...
<!--{if empty($topic) || ($topic[usefooter])}-->
    ...
    <div id="wk_ft">
        <div class="wk_foot">
            <div class="wk_foot_c">
            	<div class="wk_foot_info">
                	<!--{if $foot_map}-->
                	<iframe width="100%" height="100%" src="template/week_education/portal/map.htm" scrolling="no" frameborder="0"></iframe>
                    <!--{else}-->
                    <div class="support">
                        <dl class="ft-newbie">
                            <dt><span>$week_lang[85]</span></dt>
                            <dd><b></b>$week_lang[86]</dd>
                            <dd><b></b>$week_lang[87]</dd>
                            <dd><b></b>$week_lang[88]</dd>
                            <dd><b></b>$week_lang[89]</dd>
                        </dl>
                        <dl class="ft-delivery">
                            <dt><span>$week_lang[90]</span></dt>
                            <dd><b></b>$week_lang[91]</dd>
                            <dd><b></b>$week_lang[92]</dd>
                            <dd><b></b>$week_lang[93]</dd>
                            <dd><b></b>$week_lang[94]</dd>
                        </dl>
                        <dl class="ft-wares">
                            <dt><span>$week_lang[95]</span></dt>
                            <dd><b></b>$week_lang[96]</dd>
                            <dd><b></b>$week_lang[97]</dd>
                            <dd><b></b>$week_lang[98]</dd>
                            <dd><b></b>$week_lang[99]</dd>
                        </dl>
                    </div>    
                    <!--{/if}-->
                </div>
                <div class="wk_foot_tel">
                    <div class="wk_foot_tel_f">
                        <div class="wk_foot_add">$week_lang[100]</div>
                        <div class="wk_foot_phone">$week_lang[101]</div>
                        <div class="wk_foot_fax">$week_lang[102]</div>
                    </div>
                    <div id="wk_foot_fx_add" class="wk_foot_fx_add">
                        <div class="bdsharebuttonbox" data-tag="share_32"><a href="#" class="bds_more" data-cmd="more"></a><a href="#" class="bds_weixin" data-cmd="weixin" title="$week_lang[78]"></a><a href="#" class="bds_douban" data-cmd="douban" title="$week_lang[79]"></a><a href="#" class="bds_qzone" data-cmd="qzone" title="$week_lang[80]"></a><a href="#" class="bds_tsina" data-cmd="tsina" title="$week_lang[81]"></a><a href="#" class="bds_renren" data-cmd="renren" title="$week_lang[82]"></a><a href="#" class="bds_tqq" data-cmd="tqq" title="$week_lang[83]"></a></div>
    <script>window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"","bdMini":"2","bdMiniList":false,"bdPic":"","bdStyle":"0"},"share": [{"tag" : "share_16","bdSize" : 16},{"tag" : "share_32","bdSize" : 32} ]};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];</script>
        ...
        <div id="ft" class="wp cl" style="background:#282828; border:0;">
          <div id="flk">
                <p>
                	Copyright &copy; 2014 Powered by <strong><a href="http://www.discuz.net" title="Discuz!" target="_blank">Discuz!</a></strong> <em>$_G['setting']['version']</em><!--{if !empty($_G['setting']['boardlicensed'])}--> <a href="http://license.comsenz.com/?pid=1&host=$_SERVER[HTTP_HOST]" target="_blank">Licensed</a><!--{/if}-->
					<strong> <a href="http://www.moke8.com/" title="moke8" target="_blank">$week_lang[5]</a> <!--$week_lang[6]--> </strong>
					...
					<!--{if $_G['setting']['site_qq']}--><span class="pipe"></span><a href="http://wpa.qq.com/msgrd?V=3&Uin=$_G['setting']['site_qq']&Site=$_G['setting']['bbname']&Menu=yes&from=discuz" target="_blank" title="QQ"><img src="{IMGDIR}/site_qq.jpg" alt="QQ" /></a><!--{/if}-->
          		</p>
            </div>
            <!--{eval updatesession();}-->
