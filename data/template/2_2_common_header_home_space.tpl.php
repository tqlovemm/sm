...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1458601948, '2', './data/template/2_2_common_header_home_space.tpl.php', './template/yingxiao_toutiao2_m', 'common/header_home_space')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1458601948, '2', './data/template/2_2_common_header_home_space.tpl.php', './template/yingxiao_toutiao2_m', 'common/header_home_space')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1458601948, '2', './data/template/2_2_common_header_home_space.tpl.php', './template/yingxiao_toutiao2_m', 'common/header_home_space')
;?>
