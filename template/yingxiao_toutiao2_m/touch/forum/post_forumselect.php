...
<div class="c forumlistpbl_box">
	...
	<ul class="forumlistpbl cl">
		...
		<!--{if $_G['group']['allowpost'] || !$_G['uid']}-->
			<!--{if $special === null}-->
				<button id="postbtn" class="pn pnc z" onclick="hideWindow('nav');showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=' + selectfid + '&mobile=2')" disabled="disabled">{lang send_posts}</button>
			<!--{else}-->
