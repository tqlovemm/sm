...
<!-- main postbox start -->
    ...
    <!--{/if}-->
		...
		<ul class="cl">
			...
			<!--{/if}-->
			<li class="area mbn">
			<textarea class="pt" id="needmessage" tabindex="3" autocomplete="off" id="{$editorid}_textarea" name="$editor[textarea]" cols="80" rows="4"  placeholder="{lang thread_content}" fwin="reply" >$postinfo[message]</textarea>
			</li>
...
<script type="text/javascript" src="template/yingxiao_toutiao2_m/toutiao_mobile/js/ajaxfileupload.js?{VERHASH}"></script>
<script type="text/javascript" src="template/yingxiao_toutiao2_m/toutiao_mobile/js/buildfileupload.js?{VERHASH}"></script>
<script type="text/javascript">
