...
0
|| checktplrefresh('./template/default/forum/seccheck_post.htm', './template/default/common/seccheck.htm', 1463030738, '2', './data/template/2_2_forum_seccheck_post.tpl.php', './template/yingxiao_toutiao2_m', 'forum/seccheck_post')
;?><?php
$sectpl = <<<EOF
