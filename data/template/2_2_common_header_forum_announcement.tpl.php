...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1459739044, '2', './data/template/2_2_common_header_forum_announcement.tpl.php', './template/yingxiao_toutiao2_m', 'common/header_forum_announcement')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1459739044, '2', './data/template/2_2_common_header_forum_announcement.tpl.php', './template/yingxiao_toutiao2_m', 'common/header_forum_announcement')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1459739044, '2', './data/template/2_2_common_header_forum_announcement.tpl.php', './template/yingxiao_toutiao2_m', 'common/header_forum_announcement')
;?>
