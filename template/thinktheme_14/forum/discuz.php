...
<div class="tt_bbsindex">
	<div class="tt_bbsindexl">
    	<script type="text/javascript" src="$_G['style']['styleimgdir']/js/jquery-1.8.2.min.js"></script>
	<div class="pro-switch">
		<div class="slider">
			<div class="flexslider">
            	<!--[diy=tt_bbs_flash]--><div id="tt_bbs_flash" class="area"></div><!--[/diy]-->
			</div>
		</div>
	</div>

<script defer src="$_G['style']['styleimgdir']/js/tt_flash.js"></script> 
...
<script type="text/javascript">
    ...
    <div class="tt_bbsindexr">   	
        <div class="slideTxtBox">
  <div class="hd">
    	<!--[diy=tt_bbs_newstitle]--><div id="tt_bbs_newstitle" class="area"></div><!--[/diy]-->    
  </div>
  <div class="bd">
    <ul>
      <!--[diy=tt_bbs_news1]--><div id="tt_bbs_news1" class="area"></div><!--[/diy]--> 
    </ul>
    <ul>
      <!--[diy=tt_bbs_news2]--><div id="tt_bbs_news2" class="area"></div><!--[/diy]--> 
    </ul>
    <ul>
      <!--[diy=tt_bbs_news3]--><div id="tt_bbs_news3" class="area"></div><!--[/diy]--> 
    </ul>
  </div>
</div>
<script src="$_G['style']['styleimgdir']/js/jquery.min.js"></script>
<script src="$_G['style']['styleimgdir']/js/superslide.2.1.js"></script>
...
<div id="ct" class="wp cl{if $_G['setting']['forumallowside']} ct2{/if}">
	<!--{if empty($gid)}-->
		<div id="chart" class="bm bw0 cl tt_chart">
						...
						<!--{if $cat['forumcolumns']}-->
							...
							<td class="fl_g" width="$cat[forumcolwidth]">
								...
								<dl{if !empty($forum[extra][iconwidth]) && !empty($forum[icon])} style="margin-left: {$forum[extra][iconwidth]}px;"{/if}>
                                    ...
                                    <p class="xg2" style="padding-bottom:5px; color:#888">$forum[description]</p>
                                    <!--{else}-->
                                    <style>
									.xi2{ color:#888}
									cite{color:#888}
                                    ...
                                    <!--{/if}-->
                                    <!--{if empty($forum[redirect])}--><dd><em style="margin-right:10px">{lang forum_threads}: <!--{echo dnumber($forum[threads])}--></em><em>{lang forum_posts}: <!--{echo dnumber($forum[posts])}--></em></dd><!--{/if}-->
