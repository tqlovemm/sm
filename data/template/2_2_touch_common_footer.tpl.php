...
0
|| checktplrefresh('./template/yingxiao_toutiao2_m/touch/common/footer.htm', './template/yingxiao_toutiao2_m/touch/common/ceo_btoolbar.htm', 1456881744, '2', './data/template/2_2_touch_common_footer.tpl.php', './template/yingxiao_toutiao2_m', 'touch/common/footer')
|| checktplrefresh('./template/yingxiao_toutiao2_m/touch/common/footer.htm', './template/yingxiao_toutiao2_m/touch/common/ceo_sidemenus.htm', 1456881744, '2', './data/template/2_2_touch_common_footer.tpl.php', './template/yingxiao_toutiao2_m', 'touch/common/footer')
;?>
