...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1460362538, '2', './data/template/2_2_common_header_group_index.tpl.php', './template/yingxiao_toutiao2_m', 'common/header_group_index')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1460362538, '2', './data/template/2_2_common_header_group_index.tpl.php', './template/yingxiao_toutiao2_m', 'common/header_group_index')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1460362538, '2', './data/template/2_2_common_header_group_index.tpl.php', './template/yingxiao_toutiao2_m', 'common/header_group_index')
;?>
